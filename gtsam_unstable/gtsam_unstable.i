...
class PoseRTV {
  ...
  gtsam::Point3 translationIntegration(const gtsam::PoseRTV& x2,
                                       double dt) const;
  gtsam::Vector translationIntegrationVec(const gtsam::PoseRTV& x2,
                                          double dt) const;
...
virtual class VelocityConstraint3 : gtsam::NonlinearFactor {
  ...
  gtsam::Vector evaluateError(const double& x1, const double& x2,
...
virtual class PendulumFactor1 : gtsam::NonlinearFactor {
  ...
  gtsam::Vector evaluateError(const double& qk1, const double& qk,
                              const double& v) const;
};
...
virtual class PendulumFactor2 : gtsam::NonlinearFactor {
  ...
  gtsam::Vector evaluateError(const double& vk1, const double& vk,
...
virtual class PendulumFactorPk : gtsam::NonlinearFactor {
  ...
  gtsam::Vector evaluateError(const double& pk, const double& qk,
...
virtual class PendulumFactorPk1 : gtsam::NonlinearFactor {
  ...
  gtsam::Vector evaluateError(const double& pk1, const double& qk,
                              const double& qk1) const;
};
...
virtual class Reconstruction : gtsam::NoiseModelFactor {
  ...
  gtsam::Vector evaluateError(const gtsam::Pose3& gK1, const gtsam::Pose3& gK,
...
virtual class DiscreteEulerPoincareHelicopter : gtsam::NoiseModelFactor {
  ...
  gtsam::Vector evaluateError(const gtsam::Vector& xiK,
                              const gtsam::Vector& xiK_1,
