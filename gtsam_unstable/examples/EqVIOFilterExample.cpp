...
/// @brief Minimal standalone run of gtsam::EqVIOFilter.
...
int main() {
  ...
  std::vector<Landmark> landmarks = {
      {Point3(1.0, -0.2, 4.0), 1},
      {Point3(-0.8, 0.5, 5.0), 2},
      {Point3(0.2, 0.9, 6.0), 3},
  };
  VIOState xi0(sensor, landmarks);
  ...
  std::cout << "EqVIOFilter example completed.\n";
