...
if(DEFINED GTSAM_USE_SYSTEM_SUITESPARSE)
...
option(GTSAM_USE_SYSTEM_SUITESPARSE
  "${_gtsam_suitesparse_option_description}"
  ON)

if(GTSAM_USE_SYSTEM_SUITESPARSE AND NOT TARGET SuiteSparse::CCOLAMD)
  find_package(CCOLAMD CONFIG QUIET)
  if(NOT TARGET SuiteSparse::CCOLAMD)
    if(_gtsam_suitesparse_selection_explicit)
      message(FATAL_ERROR
        "GTSAM_USE_SYSTEM_SUITESPARSE is ON, but no CCOLAMD config package "
        "providing SuiteSparse::CCOLAMD was found")
    else()
      set(GTSAM_USE_SYSTEM_SUITESPARSE OFF CACHE BOOL
        "${_gtsam_suitesparse_option_description}" FORCE)
    endif()
  endif()
endif()

if(GTSAM_USE_SYSTEM_SUITESPARSE)
  if(CCOLAMD_VERSION)
