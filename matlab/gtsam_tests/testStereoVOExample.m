...
x1 = gtsam.symbol('x',1); x2 = gtsam.symbol('x',2);
l1 = gtsam.symbol('l',1); l2 = gtsam.symbol('l',2); l3 = gtsam.symbol('l',3);
...
stereo_model = gtsam.noiseModel.Diagonal.Sigmas([1.0; 1.0; 1.0]);
...
initialEstimate.insert(x2, gtsam.Pose3( ...
    gtsam.Rot3(), gtsam.Point3(0.1,-.1,1.1)));
...
gtsam.CHECK('pose_x1.equals(first_pose,1e-4)',pose_x1.equals(first_pose,1e-4));

point_l1 = result.atPoint3(l1);
gtsam.CHECK('point_1.equals(expected_l1,1e-4)',norm(point_l1 - expected_l1) < 1e-4);
