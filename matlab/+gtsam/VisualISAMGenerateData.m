...
if options.triangle % Create a triangle target, just 3 points on a plane
    ...
    for j=1:nrPoints
        ...
        truth.points{j} = [r*cos(theta), r*sin(theta), 0]';
    end
else % 3D landmarks as vertices of a cube
    nrPoints = 8;
    truth.points = {[10 10 10]',...
        [-10 10 10]',...
        [-10 -10 10]',...
        [10 -10 10]',...
        [10 10 -10]',...
...
for i=1:options.nrCameras
    ...
    t = [r*cos(theta), r*sin(theta), height]';
    truth.cameras{i} = PinholeCameraCal3_S2.Lookat(t, [0, 0, 0]', [0,0,1]', truth.K);
    % Create measurements
    for j=1:nrPoints
