...
finalVelocityGlobal = initialVelocityGlobal + (initialPoseGlobal.rotation().rotate(finalVelocityBody) );
finalPosition = initialPoseGlobal.translation().vector() + initialPoseGlobal.rotation().rotate(finalPositionBody) ;
