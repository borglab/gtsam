...
% into the IMU frame.
measuredOmega = imuFrame.rotation.unrotate(omega1Body).vector;
...
velocity1inertial = imuFrame.rotation.unrotate( ...
    velocity1Body + cross(omega1Body, imuFrame.translation.vector));

imu2in1 = Rot3.Expmap(measuredOmega * deltaT);
velocity2inertial = imu2in1.rotate(imuFrame.rotation.unrotate( ...
    velocity2Body + cross(omega2Body, imuFrame.translation.vector)));
