...
|:------------:|:---------:|:-------------:|
| Ubuntu 20.04 | gcc 9/clang 9 | ![Linux CI](https://github.com/borglab/gtsam/workflows/Linux%20CI/badge.svg) |
| MacOS 11       | Xcode 13.4.1     | ![macOS CI](https://github.com/borglab/gtsam/workflows/macOS%20CI/badge.svg) |
...
And, optionally, if you want python bindings:
```sh
make python-install
make python-test # (optional, runs unit tests)
```

Prerequisites:

- [Boost](http://www.boost.org/users/download/) >= 1.67 (Ubuntu: `sudo apt-get install libboost-all-dev`)
- [CMake](http://www.cmake.org/cmake/resources/software.html) >= 3.4 (Ubuntu: `sudo apt-get install cmake`)
- A modern C++11 compiler, i.e., we recommend GCC >=9 or Clang >=9 on Linux. GCC 7 and 8 were EOL in 2021 and will no longer be supported beyond 4.2.
