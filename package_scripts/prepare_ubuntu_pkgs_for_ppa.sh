...
export gtsam_release_EXTRA_OTHERLIBS_URL="https://github.com/GTSAM/octomap/archive/devel.zip"
export gtsam_release_EXTRA_OTHERLIBS_PATH="otherlibs/octomap.zip"
...
do
	...
	DEBCHANGE_CMD="--newversion 1:${GTSAM_VERSION_STR}~snapshot${GTSAM_SNAPSHOT_VERSION}${DEBIAN_DIST}-1~ppa1~${DEBIAN_DIST}"
