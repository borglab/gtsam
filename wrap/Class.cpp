...
void Class::pointer_constructor_fragments(FileWriter& proxyFile,
  ...
  wrapperFile.oss << "  typedef std::shared_ptr<" << cppName << "> Shared;\n";
  wrapperFile.oss << "\n";
  ...
  if (cppBaseName) {
    wrapperFile.oss << "\n";
    wrapperFile.oss << "  typedef std::shared_ptr<" << *cppBaseName
        << "> SharedBase;\n";
    wrapperFile.oss
  ...
  if (isVirtual)
    wrapperFile.oss << "\n"
        ...
        << "(int nargout, mxArray *out[], int nargin, const mxArray *in[]) {\n"
            ...
            "  typedef std::shared_ptr<" << cppName
        << "> Shared;\n"
...
//{
//  typedef std::shared_ptr<Point3> Shared;
