...
The estimated generic Jacobian transfer is `553,336 x (24 Jacobian + 2 residual) x 8 B = 115,093,888 B` (115.1 decimal MB). Dividing by `9.50 GiB/s` gives 11.284 ms. Adding that estimate to the repeat-0-excluded sensitivity-view lower bound gives 73.422 ms, but neither 62.139 ms nor 73.422 ms is an end-to-end timing. Sparse packing, the actual generic J/H numeric layout, repeated upload, delta download/mapping, and convergence remain unmeasured.
