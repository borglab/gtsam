 ...
 */
class GTSAM_EXPORT CudaSfmReducedCsrPlan {
 public:
  CudaSfmReducedCsrPlan(const SfmData& data,
  ...
  const CudaBlockLayout& cameraBlocks() const { return cameraBlocks_; }
