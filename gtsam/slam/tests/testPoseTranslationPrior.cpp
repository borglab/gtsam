...
TEST( testPoseTranslationFactor, level3_zero_error ) {
  ...
  Matrix expH1 = numericalDerivative22<Vector3,Pose3TranslationPrior,Pose3>(evalFactorError3, factor, pose1, GTSAM_UNITTEST_TOLERANCE_LOOSE);
...
TEST( testPoseTranslationFactor, level2_zero_error ) {
  ...
  Matrix expH1 = numericalDerivative22<Vector2,Pose2TranslationPrior,Pose2>(evalFactorError2, factor, pose1, GTSAM_UNITTEST_TOLERANCE_LOOSE);
  EXPECT(assert_equal(expH1, actH1, tol));
}
