...
TEST( InitializePose3, iterationGradient ) {
  ...
  EXPECT(assert_equal(R0Expected, orientations.at<Rot3>(x0), GTSAM_UNITTEST_TOLERANCE_LOOSE));
  ...
  EXPECT(assert_equal(R1Expected, orientations.at<Rot3>(x1), GTSAM_UNITTEST_TOLERANCE_LOOSE));
  ...
  EXPECT(assert_equal(R2Expected, orientations.at<Rot3>(x2), GTSAM_UNITTEST_TOLERANCE_LOOSE));
  ...
  EXPECT(assert_equal(R3Expected, orientations.at<Rot3>(x3), GTSAM_UNITTEST_TOLERANCE_LOOSE));
}
