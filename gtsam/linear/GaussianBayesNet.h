...
//=============================== MHGaussianBayesNet =============================
/*
  //TODO: takes MHGaussianConditional
  class GTSAM_EXPORT MHGaussianBayesNet: public FactorGraph<MHGaussianConditional>
  {
  public:

    typedef FactorGraph<MHGaussianConditional> Base;
    typedef MHGaussianBayesNet This;
    typedef MHGaussianConditional ConditionalType;
    typedef boost::shared_ptr<This> shared_ptr; 
    typedef boost::shared_ptr<ConditionalType> sharedConditional;
    ...
    // Construct from iterator over conditionals
    //template<typename ITERATOR> GaussianBayesNet(ITERATOR firstConditional, ITERATOR lastConditional) : Base(firstConditional, lastConditional) {}
    

    // Construct from container of factors (shared_ptr or plain objects) 
    //template<class CONTAINER> explicit MHGaussianBayesNet(const CONTAINER& conditionals) : Base(conditionals) {}

    // Implicit copy/downcast constructor to override explicit template container constructor
    //template<class DERIVEDCONDITIONAL> MHGaussianBayesNet(const FactorGraph<DERIVEDCONDITIONAL>& graph) : Base(graph) {}
  ...
  /// traits
  template<>
  struct traits<MHGaussianBayesNet> : public Testable<MHGaussianBayesNet> {
  };
// */

//=============================== END MHGaussianBayesNet =============================
