...
void CudaSparseSpdOperator::apply(const double* input, double* output,
...
void CudaSparseSpdJacobiPreconditioner::build(
...
void CudaSparseSpdJacobiPreconditioner::apply(
