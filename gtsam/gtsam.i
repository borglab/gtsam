...
template<T = {Vector, gtsam::Point2, gtsam::StereoPoint2, gtsam::Point3, gtsam::Rot2, gtsam::SO3, gtsam::SO4, gtsam::SOn, gtsam::Rot3, gtsam::Pose2, gtsam::Pose3, gtsam::Unit3, gtsam::Cal3_S2, gtsam::Cal3Bundler, gtsam::CalibratedCamera, gtsam::PinholeCameraCal3_S2, gtsam::imuBias::ConstantBias, gtsam::PinholeCamera<gtsam::Cal3Bundler>}>
...
typedef gtsam::GeneralSFMFactor2<gtsam::Cal3DS2> GeneralSFMFactor2Cal3DS2;
typedef gtsam::GeneralSFMFactor2<gtsam::Cal3Bundler> GeneralSFMFactor2Cal3Bundler;
