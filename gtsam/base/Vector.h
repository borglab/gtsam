...
static_assert(GTSAM_EIGEN_VERSION_WORLD == EIGEN_WORLD_VERSION &&
 ...
 */
GTSAM_EXPORT void save(const Vector& A, const std::string& s,
 ...
 */
GTSAM_EXPORT bool equal_with_abs_tol(const Vector& vec1, const Vector& vec2,
                                     double tol = 1e-9);
GTSAM_EXPORT bool equal_with_abs_tol(const SubVector& vec1,
                                     const SubVector& vec2, double tol = 1e-9);
 ...
 * @return bool
 */
GTSAM_EXPORT bool assert_equal(const Vector& vec1, const Vector& vec2,
                               double tol = 1e-9);
 ...
 * @return bool
 */
GTSAM_EXPORT bool assert_inequal(const Vector& vec1, const Vector& vec2,
                                 double tol = 1e-9);
 ...
 * @return bool
 */
GTSAM_EXPORT bool assert_equal(const SubVector& vec1, const SubVector& vec2,
                               double tol = 1e-9);
GTSAM_EXPORT bool assert_equal(const ConstSubVector& vec1,
                               const ConstSubVector& vec2, double tol = 1e-9);
 ...
 * @return bool
 */
GTSAM_EXPORT bool linear_dependent(const Vector& vec1, const Vector& vec2,
                                   double tol = 1e-9);
 ...
 */
GTSAM_EXPORT std::pair<Vector, double> weightedPseudoinverse(
    const Vector& v, const Vector& weights);
 ...
 */
GTSAM_EXPORT double weightedPseudoinverse(const Vector& a,
...
inline Vector repeat(size_t n, double value) {
  return Vector::Constant(n, value);
}
inline const Vector sub(const Vector& v, size_t i1, size_t i2) {
  return v.segment(i1, i2 - i1);
}
inline void subInsert(Vector& fullVector, const Vector& subVector, size_t i) {
