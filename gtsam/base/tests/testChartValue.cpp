...
//GTSAM_CONCEPT_TESTABLE_INST(ChartValue<Pose3>)  // traits of Pose3 not ready yet :-(
...
TEST( testChartValue, addition_to_values ) {
  ...
  ChartValue<Vector3> v3 = values.at<ChartValue<Vector3> >(44); // throws ! // not sure how to do an EXPECT_FAIL
