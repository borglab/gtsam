...
TEST(testNumericalDerivative, numericalHessian2) {
  ...
  Matrix expected =
      (Matrix(2, 2) << -cos(x(1)) * sin(x(0)), -sin(x(1)) * cos(x(0)),
...
/* ************************************************************************* */
double f3(double x1, double x2) { return sin(x1) * cos(x2); }
...
TEST(testNumericalDerivative, numericalHessian212) {
  // TODO should implement test for all the variants of numerical Hessian, for
  // mixed dimension types, like Point3 y = Project(Camera, Point3); I'm not
  // sure how numericalHessian212 is different from 211 or 222 -Mike B.
}

/* ************************************************************************* */
double f4(double x, double y, double z) { return sin(x) * cos(y) * z * z; }
...
Vector6 f6(const double x1, const double x2, const double x3, const double x4,
  ...
  Vector6 result;
  result << sin(x1), cos(x2), x3 * x3, x4 * x4 * x4, sqrt(x5),
      sin(x6) - cos(x6);
  return result;
}
...
TEST(testNumericalDerivative, numeriDerivative61) {
  ...
  Matrix61 actual61 =
      numericalDerivative61<Vector6, double, double, double, double, double,
                            double>(f6, x1, x2, x3, x4, x5, x6);
...
TEST(testNumericalDerivative, numeriDerivative62) {
  ...
  Matrix61 actual62 =
      numericalDerivative62<Vector6, double, double, double, double, double,
                            double>(f6, x1, x2, x3, x4, x5, x6);
...
TEST(testNumericalDerivative, numeriDerivative63) {
  ...
  Matrix61 actual63 =
      numericalDerivative63<Vector6, double, double, double, double, double,
                            double>(f6, x1, x2, x3, x4, x5, x6);
...
TEST(testNumericalDerivative, numeriDerivative64) {
  ...
  Matrix61 actual64 =
      numericalDerivative64<Vector6, double, double, double, double, double,
                            double>(f6, x1, x2, x3, x4, x5, x6);
...
TEST(testNumericalDerivative, numeriDerivative65) {
  ...
  Matrix expected65 =
      (Matrix(6, 1) << 0, 0, 0, 0, 0.5 / sqrt(x5), 0).finished();
  Matrix61 actual65 =
      numericalDerivative65<Vector6, double, double, double, double, double,
                            double>(f6, x1, x2, x3, x4, x5, x6);
...
TEST(testNumericalDerivative, numeriDerivative66) {
  ...
  Matrix expected66 =
      (Matrix(6, 1) << 0, 0, 0, 0, 0, cos(x6) + sin(x6)).finished();
  Matrix61 actual66 =
      numericalDerivative66<Vector6, double, double, double, double, double,
                            double>(f6, x1, x2, x3, x4, x5, x6);
