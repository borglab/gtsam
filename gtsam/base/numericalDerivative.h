...
/*
 * Note that all of these functions have two versions, a boost.function version
 * and a standard C++ function pointer version.  This allows reformulating the
 * arguments of a function to fit the correct structure, which is useful for
 * situations like member functions and functions with arguments not involved in
 * the derivative:
 *
 ...
 *   This syntax will fix the optional argument to boost::none, while using the
 * first argument provided
 *
 * For member functions, such as below, with an instantiated copy
 * instanceOfSomeClass Foo SomeClass::bar(const Obj& a) Use boost bind as
 * follows to create a function pointer that uses the member function:
...
// a quick helper struct to get the appropriate fixed sized matrix from two
// value types
namespace internal {
 ...
 * int N is the dimension of the X input value if variable dimension type but
 * known at test time
 */
...
typename Eigen::Matrix<double, N, 1> numericalGradient(
  ...
  BOOST_STATIC_ASSERT_MSG(
      (boost::is_base_of<manifold_tag,
                         typename traits<X>::structure_category>::value),
...
typename internal::FixedSizeMatrix<Y, X>::type numericalDerivative11(
  ...
  BOOST_STATIC_ASSERT_MSG(
      (boost::is_base_of<gtsam::manifold_tag,
                         typename traits<Y>::structure_category>::value),
...
typename internal::FixedSizeMatrix<Y, X1>::type numericalDerivative21(
    const boost::function<Y(const X1&, const X2&)>& h, const X1& x1,
  ...
  BOOST_STATIC_ASSERT_MSG(
      (boost::is_base_of<gtsam::manifold_tag,
                         typename traits<X1>::structure_category>::value),
      "Template argument X1 must be a manifold type.");
  return numericalDerivative11<Y, X1>(boost::bind(h, _1, boost::cref(x2)), x1,
                                      delta);
}
...
template <class Y, class X1, class X2>
typename internal::FixedSizeMatrix<Y, X1>::type numericalDerivative21(
    Y (*h)(const X1&, const X2&), const X1& x1, const X2& x2,
    double delta = 1e-5) {
  return numericalDerivative21<Y, X1, X2>(boost::bind(h, _1, _2), x1, x2,
                                          delta);
}
 ...
 */
template <class Y, class X1, class X2>
typename internal::FixedSizeMatrix<Y, X2>::type numericalDerivative22(
    boost::function<Y(const X1&, const X2&)> h, const X1& x1, const X2& x2,
    double delta = 1e-5) {
  //  BOOST_STATIC_ASSERT_MSG( (boost::is_base_of<gtsam::manifold_tag, typename
  //  traits<X1>::structure_category>::value),
  //       "Template argument X1 must be a manifold type.");
  BOOST_STATIC_ASSERT_MSG(
      (boost::is_base_of<gtsam::manifold_tag,
                         typename traits<X2>::structure_category>::value),
      "Template argument X2 must be a manifold type.");
  return numericalDerivative11<Y, X2>(boost::bind(h, boost::cref(x1), _1), x2,
                                      delta);
}
...
typename internal::FixedSizeMatrix<Y, X2>::type numericalDerivative22(
    Y (*h)(const X1&, const X2&), const X1& x1, const X2& x2,
    double delta = 1e-5) {
  return numericalDerivative22<Y, X1, X2>(boost::bind(h, _1, _2), x1, x2,
                                          delta);
}
...
typename internal::FixedSizeMatrix<Y, X1>::type numericalDerivative31(
  ...
  BOOST_STATIC_ASSERT_MSG(
      (boost::is_base_of<gtsam::manifold_tag,
                         typename traits<X1>::structure_category>::value),
      "Template argument X1 must be a manifold type.");
  return numericalDerivative11<Y, X1>(
      boost::bind(h, _1, boost::cref(x2), boost::cref(x3)), x1, delta);
}

template <class Y, class X1, class X2, class X3>
typename internal::FixedSizeMatrix<Y, X1>::type numericalDerivative31(
    Y (*h)(const X1&, const X2&, const X3&), const X1& x1, const X2& x2,
...
typename internal::FixedSizeMatrix<Y, X2>::type numericalDerivative32(
  ...
  BOOST_STATIC_ASSERT_MSG(
      (boost::is_base_of<gtsam::manifold_tag,
                         typename traits<X2>::structure_category>::value),
      "Template argument X2 must be a manifold type.");
  return numericalDerivative11<Y, X2>(
      boost::bind(h, boost::cref(x1), _1, boost::cref(x3)), x2, delta);
}

template <class Y, class X1, class X2, class X3>
inline typename internal::FixedSizeMatrix<Y, X2>::type numericalDerivative32(
    Y (*h)(const X1&, const X2&, const X3&), const X1& x1, const X2& x2,
    const X3& x3, double delta = 1e-5) {
...
typename internal::FixedSizeMatrix<Y, X3>::type numericalDerivative33(
  ...
  BOOST_STATIC_ASSERT_MSG(
      (boost::is_base_of<gtsam::manifold_tag,
                         typename traits<X3>::structure_category>::value),
      "Template argument X3 must be a manifold type.");
  return numericalDerivative11<Y, X3>(
      boost::bind(h, boost::cref(x1), boost::cref(x2), _1), x3, delta);
}

template <class Y, class X1, class X2, class X3>
inline typename internal::FixedSizeMatrix<Y, X3>::type numericalDerivative33(
    Y (*h)(const X1&, const X2&, const X3&), const X1& x1, const X2& x2,
    const X3& x3, double delta = 1e-5) {
...
typename internal::FixedSizeMatrix<Y, X1>::type numericalDerivative41(
    boost::function<Y(const X1&, const X2&, const X3&, const X4&)> h,
  ...
  BOOST_STATIC_ASSERT_MSG(
      ...
      "Template argument X1 must be a manifold type.");
  return numericalDerivative11<Y, X1>(
      boost::bind(h, _1, boost::cref(x2), boost::cref(x3), boost::cref(x4)), x1,
      delta);
}

template <class Y, class X1, class X2, class X3, class X4>
inline typename internal::FixedSizeMatrix<Y, X1>::type numericalDerivative41(
    Y (*h)(const X1&, const X2&, const X3&, const X4&), const X1& x1,
    const X2& x2, const X3& x3, const X4& x4, double delta = 1e-5) {
  return numericalDerivative41<Y, X1, X2, X3, X4>(
      boost::bind(h, _1, _2, _3, _4), x1, x2, x3, x4);
}
...
typename internal::FixedSizeMatrix<Y, X2>::type numericalDerivative42(
  ...
  BOOST_STATIC_ASSERT_MSG(
      ...
      "Template argument X2 must be a manifold type.");
  return numericalDerivative11<Y, X2>(
      boost::bind(h, boost::cref(x1), _1, boost::cref(x3), boost::cref(x4)), x2,
      delta);
}

template <class Y, class X1, class X2, class X3, class X4>
inline typename internal::FixedSizeMatrix<Y, X2>::type numericalDerivative42(
    Y (*h)(const X1&, const X2&, const X3&, const X4&), const X1& x1,
    const X2& x2, const X3& x3, const X4& x4, double delta = 1e-5) {
...
typename internal::FixedSizeMatrix<Y, X3>::type numericalDerivative43(
  ...
  BOOST_STATIC_ASSERT_MSG(
      ...
      "Template argument X3 must be a manifold type.");
  return numericalDerivative11<Y, X3>(
      boost::bind(h, boost::cref(x1), boost::cref(x2), _1, boost::cref(x4)), x3,
      delta);
}

template <class Y, class X1, class X2, class X3, class X4>
inline typename internal::FixedSizeMatrix<Y, X3>::type numericalDerivative43(
    Y (*h)(const X1&, const X2&, const X3&, const X4&), const X1& x1,
    const X2& x2, const X3& x3, const X4& x4, double delta = 1e-5) {
...
typename internal::FixedSizeMatrix<Y, X4>::type numericalDerivative44(
  ...
  BOOST_STATIC_ASSERT_MSG(
      (boost::is_base_of<gtsam::manifold_tag,
                         typename traits<X4>::structure_category>::value),
      "Template argument X4 must be a manifold type.");
  return numericalDerivative11<Y, X4>(
      boost::bind(h, boost::cref(x1), boost::cref(x2), boost::cref(x3), _1), x4,
      delta);
}

template <class Y, class X1, class X2, class X3, class X4>
inline typename internal::FixedSizeMatrix<Y, X4>::type numericalDerivative44(
    Y (*h)(const X1&, const X2&, const X3&, const X4&), const X1& x1,
    const X2& x2, const X3& x3, const X4& x4, double delta = 1e-5) {
...
typename internal::FixedSizeMatrix<Y, X1>::type numericalDerivative51(
    boost::function<Y(const X1&, const X2&, const X3&, const X4&, const X5&)> h,
    const X1& x1, const X2& x2, const X3& x3, const X4& x4, const X5& x5,
    double delta = 1e-5) {
  BOOST_STATIC_ASSERT_MSG(
      (boost::is_base_of<gtsam::manifold_tag,
                         typename traits<Y>::structure_category>::value),
  ...
  BOOST_STATIC_ASSERT_MSG(
      ...
      "Template argument X1 must be a manifold type.");
  return numericalDerivative11<Y, X1>(
      boost::bind(h, _1, boost::cref(x2), boost::cref(x3), boost::cref(x4),
                  boost::cref(x5)),
      x1, delta);
}

template <class Y, class X1, class X2, class X3, class X4, class X5>
inline typename internal::FixedSizeMatrix<Y, X1>::type numericalDerivative51(
    Y (*h)(const X1&, const X2&, const X3&, const X4&, const X5&), const X1& x1,
    const X2& x2, const X3& x3, const X4& x4, const X5& x5,
    double delta = 1e-5) {
  return numericalDerivative51<Y, X1, X2, X3, X4, X5>(
      boost::bind(h, _1, _2, _3, _4, _5), x1, x2, x3, x4, x5);
}
...
typename internal::FixedSizeMatrix<Y, X2>::type numericalDerivative52(
  ...
  BOOST_STATIC_ASSERT_MSG(
      ...
      "Template argument X1 must be a manifold type.");
  return numericalDerivative11<Y, X2>(
      boost::bind(h, boost::cref(x1), _1, boost::cref(x3), boost::cref(x4),
                  boost::cref(x5)),
      x2, delta);
}

template <class Y, class X1, class X2, class X3, class X4, class X5>
inline typename internal::FixedSizeMatrix<Y, X2>::type numericalDerivative52(
    Y (*h)(const X1&, const X2&, const X3&, const X4&, const X5&), const X1& x1,
    const X2& x2, const X3& x3, const X4& x4, const X5& x5,
    double delta = 1e-5) {
...
typename internal::FixedSizeMatrix<Y, X3>::type numericalDerivative53(
  ...
  BOOST_STATIC_ASSERT_MSG(
      ...
      "Template argument X1 must be a manifold type.");
  return numericalDerivative11<Y, X3>(
      boost::bind(h, boost::cref(x1), boost::cref(x2), _1, boost::cref(x4),
                  boost::cref(x5)),
      x3, delta);
}

template <class Y, class X1, class X2, class X3, class X4, class X5>
inline typename internal::FixedSizeMatrix<Y, X3>::type numericalDerivative53(
    Y (*h)(const X1&, const X2&, const X3&, const X4&, const X5&), const X1& x1,
    const X2& x2, const X3& x3, const X4& x4, const X5& x5,
    double delta = 1e-5) {
...
typename internal::FixedSizeMatrix<Y, X4>::type numericalDerivative54(
  ...
  BOOST_STATIC_ASSERT_MSG(
      ...
      "Template argument X1 must be a manifold type.");
  return numericalDerivative11<Y, X4>(
      boost::bind(h, boost::cref(x1), boost::cref(x2), boost::cref(x3), _1,
                  boost::cref(x5)),
      x4, delta);
}

template <class Y, class X1, class X2, class X3, class X4, class X5>
inline typename internal::FixedSizeMatrix<Y, X4>::type numericalDerivative54(
    Y (*h)(const X1&, const X2&, const X3&, const X4&, const X5&), const X1& x1,
    const X2& x2, const X3& x3, const X4& x4, const X5& x5,
    double delta = 1e-5) {
...
typename internal::FixedSizeMatrix<Y, X5>::type numericalDerivative55(
  ...
  BOOST_STATIC_ASSERT_MSG(
      (boost::is_base_of<gtsam::manifold_tag,
                         typename traits<X1>::structure_category>::value),
      "Template argument X1 must be a manifold type.");
  return numericalDerivative11<Y, X5>(
...
template <class Y, class X1, class X2, class X3, class X4, class X5>
inline typename internal::FixedSizeMatrix<Y, X5>::type numericalDerivative55(
    Y (*h)(const X1&, const X2&, const X3&, const X4&, const X5&), const X1& x1,
    const X2& x2, const X3& x3, const X4& x4, const X5& x5,
    double delta = 1e-5) {
...
typename internal::FixedSizeMatrix<Y, X1>::type numericalDerivative61(
    boost::function<Y(const X1&, const X2&, const X3&, const X4&, const X5&,
                      const X6&)>
        h,
    const X1& x1, const X2& x2, const X3& x3, const X4& x4, const X5& x5,
    const X6& x6, double delta = 1e-5) {
  BOOST_STATIC_ASSERT_MSG(
      (boost::is_base_of<gtsam::manifold_tag,
                         typename traits<Y>::structure_category>::value),
      "Template argument Y must be a manifold type.");
  ...
  return numericalDerivative11<Y, X1>(
      boost::bind(h, _1, boost::cref(x2), boost::cref(x3), boost::cref(x4),
                  boost::cref(x5), boost::cref(x6)),
      x1, delta);
}

template <class Y, class X1, class X2, class X3, class X4, class X5, class X6>
inline typename internal::FixedSizeMatrix<Y, X1>::type numericalDerivative61(
    Y (*h)(const X1&, const X2&, const X3&, const X4&, const X5&, const X6&),
    const X1& x1, const X2& x2, const X3& x3, const X4& x4, const X5& x5,
    const X6& x6, double delta = 1e-5) {
  return numericalDerivative61<Y, X1, X2, X3, X4, X5, X6>(
      boost::bind(h, _1, _2, _3, _4, _5, _6), x1, x2, x3, x4, x5, x6);
}
...
template <class Y, class X1, class X2, class X3, class X4, class X5, class X6>
inline typename internal::FixedSizeMatrix<Y, X2>::type numericalDerivative62(
    Y (*h)(const X1&, const X2&, const X3&, const X4&, const X5&, const X6&),
    const X1& x1, const X2& x2, const X3& x3, const X4& x4, const X5& x5,
    const X6& x6, double delta = 1e-5) {
...
template <class Y, class X1, class X2, class X3, class X4, class X5, class X6>
inline typename internal::FixedSizeMatrix<Y, X3>::type numericalDerivative63(
    Y (*h)(const X1&, const X2&, const X3&, const X4&, const X5&, const X6&),
    const X1& x1, const X2& x2, const X3& x3, const X4& x4, const X5& x5,
    const X6& x6, double delta = 1e-5) {
...
template <class Y, class X1, class X2, class X3, class X4, class X5, class X6>
inline typename internal::FixedSizeMatrix<Y, X4>::type numericalDerivative64(
    Y (*h)(const X1&, const X2&, const X3&, const X4&, const X5&, const X6&),
    const X1& x1, const X2& x2, const X3& x3, const X4& x4, const X5& x5,
    const X6& x6, double delta = 1e-5) {
...
typename internal::FixedSizeMatrix<Y, X5>::type numericalDerivative65(
  ...
  return numericalDerivative11<Y, X5>(
      boost::bind(h, boost::cref(x1), boost::cref(x2), boost::cref(x3),
                  boost::cref(x4), _1, boost::cref(x6)),
      x5, delta);
}

template <class Y, class X1, class X2, class X3, class X4, class X5, class X6>
inline typename internal::FixedSizeMatrix<Y, X5>::type numericalDerivative65(
    Y (*h)(const X1&, const X2&, const X3&, const X4&, const X5&, const X6&),
    const X1& x1, const X2& x2, const X3& x3, const X4& x4, const X5& x5,
    const X6& x6, double delta = 1e-5) {
...
typename internal::FixedSizeMatrix<Y, X5>::type numericalDerivative66(
  ...
  BOOST_STATIC_ASSERT_MSG(
      (boost::is_base_of<gtsam::manifold_tag,
                         typename traits<X1>::structure_category>::value),
      "Template argument X1 must be a manifold type.");
  return numericalDerivative11<Y, X6>(
      boost::bind(h, boost::cref(x1), boost::cref(x2), boost::cref(x3),
                  boost::cref(x4), boost::cref(x5), _1),
      x6, delta);
}

template <class Y, class X1, class X2, class X3, class X4, class X5, class X6>
inline typename internal::FixedSizeMatrix<Y, X6>::type numericalDerivative66(
    Y (*h)(const X1&, const X2&, const X3&, const X4&, const X5&, const X6&),
    const X1& x1, const X2& x2, const X3& x3, const X4& x4, const X5& x5,
    const X6& x6, double delta = 1e-5) {
 ...
 */
template <class X>
inline typename internal::FixedSizeMatrix<X, X>::type numericalHessian(
    boost::function<double(const X&)> f, const X& x, double delta = 1e-5) {
  BOOST_STATIC_ASSERT_MSG(
      (boost::is_base_of<gtsam::manifold_tag,
                         typename traits<X>::structure_category>::value),
      "Template argument X must be a manifold type.");
...
class G_x1 {
 ...
 public:
  ...
  Vector operator()(const X2& x2) {
    return numericalGradient<X1>(boost::bind(f_, _1, boost::cref(x2)), x1_,
                                 delta_);
  }
};
...
inline typename internal::FixedSizeMatrix<X1, X2>::type numericalHessian212(
  ...
  return numericalDerivative11<Vector, X2>(
      boost::function<Vector(const X2&)>(
          boost::bind<Vector>(boost::ref(g_x1), _1)),
      x2, delta);
}
...
inline typename internal::FixedSizeMatrix<X1, X1>::type numericalHessian211(
  ...
  Vector (*numGrad)(boost::function<double(const X1&)>, const X1&, double) =
      &numericalGradient<X1>;
...
inline typename internal::FixedSizeMatrix<X2, X2>::type numericalHessian222(
  ...
  Vector (*numGrad)(boost::function<double(const X2&)>, const X2&, double) =
      &numericalGradient<X2>;
...
inline typename internal::FixedSizeMatrix<X1, X1>::type numericalHessian311(
  ...
  boost::function<double(const X1&)> f2(
      boost::bind(f, _1, boost::cref(x2), boost::cref(x3)));
...
inline typename internal::FixedSizeMatrix<X2, X2>::type numericalHessian322(
  ...
  boost::function<double(const X2&)> f2(
      boost::bind(f, boost::cref(x1), _1, boost::cref(x3)));
...
inline typename internal::FixedSizeMatrix<X3, X3>::type numericalHessian333(
  ...
  Vector (*numGrad)(boost::function<double(const X3&)>, const X3&, double) =
      &numericalGradient<X3>;
  boost::function<double(const X3&)> f2(
      boost::bind(f, boost::cref(x1), boost::cref(x2), _1));
...
inline typename internal::FixedSizeMatrix<X1, X2>::type numericalHessian312(
  ...
  return numericalHessian212<X1, X2>(
      boost::function<double(const X1&, const X2&)>(
          boost::bind(f, _1, _2, boost::cref(x3))),
      x1, x2, delta);
}
...
inline typename internal::FixedSizeMatrix<X1, X3>::type numericalHessian313(
  ...
  return numericalHessian212<X1, X3>(
      boost::function<double(const X1&, const X3&)>(
          boost::bind(f, _1, boost::cref(x2), _2)),
      x1, x3, delta);
}
...
inline typename internal::FixedSizeMatrix<X2, X3>::type numericalHessian323(
  ...
  return numericalHessian212<X2, X3>(
      boost::function<double(const X2&, const X3&)>(
          boost::bind(f, boost::cref(x1), _1, _2)),
      x2, x3, delta);
}
